 ...
 */
 ...
 // debug function to stop Firebug console.log from throwing exception if Firebug not installed
...
ClusterIcon.prototype.draw = function () {
  if (this.visible_) {
    ...
    this.div_.style.zIndex = this.getZIndexFromLatLng_(this.center_);
  }
};
...
ClusterIcon.prototype.createCss = function (pos) {
  ...
  style.push('z-index:' + this.getZIndexFromLatLng_(this.center_) + ';');
...
ClusterIcon.prototype.getZIndexFromLatLng_ = function (latlng) {
